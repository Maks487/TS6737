...
WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Username_loginusername'), '123ed')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_STORE/input_Password_loginpassword'), 'o4dhHfndXO0=')
...
WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Name_name'), 'Uzytkownik')

WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Country_country'), 'Polska')

WebUI.setText(findTestObject('Object Repository/Page_STORE/input_City_city'), 'Wroclaw')

WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Credit card_card'), '123123')

WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Month_month'), '6')

WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Year_year'), '2020')
